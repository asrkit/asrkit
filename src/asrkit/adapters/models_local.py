...
_TABLE = [
    ...
    ("paraformer-zh", "Paraformer-zh（大）", "paraformer", False, ["zh", "en"], "sherpa-onnx-paraformer-zh-2024-03-09"),
    ("sensevoice", "SenseVoice", "senseVoice", False, ["zh", "en", "yue"], "sherpa-onnx-sense-voice-zh-en-ja-ko-yue-int8-2024-07-17"),
    ("paraformer-trilingual", "Paraformer 三语", "paraformer", False, ["zh", "en", "yue"], "sherpa-onnx-paraformer-trilingual-zh-cantonese-en"),
    ...
    ("zipformer-stream-zh", "Zipformer 流式-中", "transducer", True, ["zh"], "sherpa-onnx-streaming-zipformer-zh-int8-2025-06-30"),
    ("zipformer-stream-zhen", "Zipformer 流式-中英", "transducer", True, ["zh", "en"], "sherpa-onnx-streaming-zipformer-bilingual-zh-en-2023-02-20"),
    ...
    ("stream-paraformer-zhen", "流式 Paraformer 中英", "onlineParaformer", True, ["zh", "en"], "sherpa-onnx-streaming-paraformer-bilingual-zh-en"),
    ("zipformer-stream-multizh", "Zipformer 流式-中（轻量）", "transducer", True, ["zh"], "sherpa-onnx-streaming-zipformer-multi-zh-hans-2023-12-12"),
    ("zipformer-stream-xlarge", "Zipformer 流式-中（xlarge）", "transducer", True, ["zh"], "sherpa-onnx-streaming-zipformer-zh-xlarge-int8-2025-06-30"),
    ...
    ("zipformer-offline-zhen", "Zipformer 离线-中英", "offlineTransducer", False, ["zh", "en"], "sherpa-onnx-zipformer-zh-en-2023-11-22"),
    ("zipformer-cantonese", "Zipformer 离线-粤", "offlineTransducer", False, ["yue"], "sherpa-onnx-zipformer-cantonese-2024-03-13"),
    ...
    ("sensevoice-yue", "SenseVoice（粤强）", "senseVoice", False, ["zh", "en", "yue"], "sherpa-onnx-sense-voice-zh-en-ja-ko-yue-int8-2025-09-09"),
    ("paraformer-zh-2023", "Paraformer-zh（老版）", "paraformer", False, ["zh", "en"], "sherpa-onnx-paraformer-zh-2023-03-28"),
    ("paraformer-zh-chuan", "Paraformer-zh（川渝）", "paraformer", False, ["zh"], "sherpa-onnx-paraformer-zh-int8-2025-10-07"),
    ("stream-paraformer-tri", "流式 Paraformer 三语", "onlineParaformer", True, ["zh", "en", "yue"], "sherpa-onnx-streaming-paraformer-trilingual-zh-cantonese-en"),
    ("whisper-turbo", "Whisper large-v3-turbo", "whisper", False, ["zh", "en"], "sherpa-onnx-whisper-turbo"),
    ("whisper-distil-large-v2", "Whisper distil-large-v2（英）", "whisper", False, ["en"], "sherpa-onnx-whisper-distil-large-v2"),
    ...
    ("sensevoice-fp32", "SenseVoice fp32（量化对照）", "senseVoice", False, ["zh", "en"], "sherpa-onnx-sense-voice-zh-en-ja-ko-yue-2024-07-17"),
    ("firered-aed-l", "FireRedASR-AED-L（中文天花板）", "fireRedAed", False, ["zh", "en"], "sherpa-onnx-fire-red-asr-large-zh_en-2025-02-16"),
    ("qwen3-asr-0.6b", "Qwen3-ASR-0.6B int8", "qwen3Asr", False, ["zh", "en"], "sherpa-onnx-qwen3-asr-0.6B-int8-2026-03-25"),
    ("firered-aed2", "FireRedASR2-AED int8（v2 旗舰）", "fireRedAed", False, ["zh", "en"], "sherpa-onnx-fire-red-asr2-zh_en-int8-2026-02-26"),
    ("funasr-nano", "Fun-ASR-Nano int8（LLM·方言）", "funasrNano", False, ["zh", "en"], "sherpa-onnx-funasr-nano-int8-2025-12-30"),
    ("sensevoice-nano", "SenseVoice-FunASR-Nano int8", "senseVoice", False, ["zh", "en"], "sherpa-onnx-sense-voice-funasr-nano-int8-2025-12-17"),
    ("moonshine-v2-zh", "Moonshine v2 中文（超轻）", "moonshineV2", False, ["zh"], "sherpa-onnx-moonshine-base-zh-quantized-2026-02-27"),
    ("moonshine-v2-en", "Moonshine v2 英文", "moonshineV2", False, ["en"], "sherpa-onnx-moonshine-base-en-quantized-2026-02-27"),
    ("omnilingual-300m", "Meta Omnilingual 300M int8（1600 语）", "omnilingualCtc", False, ["zh", "en"], "sherpa-onnx-omnilingual-asr-1600-languages-300M-ctc-v2-int8-2026-02-05"),
]
